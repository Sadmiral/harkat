...
public class BottleDispenser {
    ...
    public int bottles, p1, p2, c1, c2, f1;
    public double money;
    public ArrayList<Bottle> bottle_array, ostetut_array;
    ...
    private BottleDispenser(String n) {
        ...
        bottle_array.add(new Bottle("Coca-Cola Zero", 1.5, 2.50));
        bottle_array.add(new Bottle("Fanta Zero", 0.5, 1.95));
        bottle_array.add(new Bottle("Fanta Zero", 0.5, 1.95));
        
        ostetut_array = new ArrayList<>();
    }
